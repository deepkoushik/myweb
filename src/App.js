  ...
  return (
    <div>
      ...
      <div className="content-section" id="home">
        ...
        <h3 id="scope">Bug Bounty Program</h3>
        <p>
        ...
        <div className="hall-of-fame" id="halloffame">
          <h3>Hall Of Fame for</h3>
          <div className="year-buttons">
            {[...Array(11)].map((_, index) => (
              <button key={index} className="year-button">
                {2015 + index}
              </button>
            ))}
          </div>
      ...
      <div className="researcher-section" id="login">
        {researchers.map((name, idx) => (
          <div key={idx} className="researcher-card">
            <img
              className="avatar"
              src={`https://i.pravatar.cc/80?img=${(idx % 70) + 1}`}
              alt={name}
            />
